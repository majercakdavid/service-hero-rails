...
class AddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update address" do
    patch address_url(@address), params: { address: { ZIP: @address.ZIP, city: @address.city, country: @address.country, name: @address.name, phone: @address.phone, state: @address.state, street: @address.street } }
