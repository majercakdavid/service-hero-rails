...
class BusinessBusinessOwnersControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @business_business_owner.business = businesses(:one)
    @business_business_owner.business_owner = business_owners(:bo_one)
  end
=begin
  ...
  test "should create business_business_owner" do
    assert_difference('BusinessBusinessOwner.count') do
      post business_business_owners_url, params: {
          business_business_owner: {
              business_id: @business_business_owner.business_id,
              business_owner_id: @business_business_owner.business_owner_id,
              date_from: @business_business_owner.date_from,
              date_to: @business_business_owner.date_to
          }
      }
    end
